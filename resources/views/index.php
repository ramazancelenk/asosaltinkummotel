				...
				<div class="row">
						<div class="6u 12u(narrower)">
							...
							<section class="box special">
								...
								<ul class="actions">
									<li><a href="/ulasim" class="button alt">Ulaşım ile ilgili detaylı bilgi alın</a></li>
								</ul>
							</section>
						...
						<div class="6u 12u(narrower)">
							...
							<section class="box special">
								...
								<ul class="actions">
									<li><a href="/mesajlar" class="button alt">Misafirlerin yorumlarını görüntüleyin</a></li>
								</ul>
							</section>
											...
											<div class="12u">
												...
												<!-- Image -->
													<section class="box">
														...
														<a href="/fotograflar" class="button fit icon fa-search">Daha fazla fotoğraf görüntülemek için tıklayın.</a>
													</section>
